...
const Travaux13 = (props) => {
  
  const dataWithoutFirst = Data[12].pics.slice(1);
...
{/* {props.trueboolroute ?  */} 
  ...
  className="central">
    <div className="central-pix">
      <img loading="eager" src={Data[12].pics[0]} className="pixHead" alt="nicocarmine" />
    </div>
    <div className="text">
      ...
      <div className="text-left">
          ...
          <p className="text-content-titre">{Data[12].titre}</p>
          <p className="text-content-soustitre">{Data[12].subtitle}</p>
        

        <p className="text-content-credit">{Data[12].credit}</p>
      </div>
      <div className="text-right">
        <p className="text-content-des">{Data[12].desc}</p>
      </div>
