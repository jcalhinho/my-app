...
const Travaux12 = (props) => {
 
  const dataWithoutFirst = Data[11].pics.slice(1);
...
{/* {props.trueboolroute ?  */} 
  ...
  className="central">
    <div className="central-pix">
      <img loading="eager" src={Data[11].pics[0]} className="pixHead" alt="nicocarmine" />
    </div>
    <div className="text">
      ...
      <div className="text-left">
          ...
          <p className="text-content-titre">{Data[11].titre}</p>
          <p className="text-content-soustitre">{Data[11].subtitle}</p>
        

        <p className="text-content-credit">{Data[11].credit}</p>
      </div>
      <div className="text-right">
        <p className="text-content-des">{Data[11].desc}</p>
      </div>
