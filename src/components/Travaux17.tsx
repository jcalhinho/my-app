...
const Travaux17 = (props) => {
  
  const dataWithoutFirst = Data[16].pics.slice(1);
...
{/* {props.trueboolroute ?  */} 
  ...
  className="central">
    <div className="central-pix">
      <img loading="eager" src={Data[16].pics[0]} className="pixHead" alt="nicocarmine" />
    </div>
    <div className="text">
      ...
      <div className="text-left">
          ...
          <p className="text-content-titre">{Data[16].titre}</p>
          <p className="text-content-soustitre">{Data[16].subtitle}</p>
        

        <p className="text-content-credit">{Data[16].credit}</p>
      </div>
      <div className="text-right">
        <p className="text-content-des">{Data[16].desc}</p>
      </div>
