...
const Travaux6 = (props) => {
   
  const dataWithoutFirst = Data[5].pics.slice(1);
  ...
  className="central">
    <div className="central-pix">
      <img loading="eager" src={Data[5].pics[0]} className="pixHead" alt="nicocarmine" />
    </div>
    <div className="text">
      ...
      <div className="text-left">
          ...
          <p className="text-content-titre">{Data[5].titre}</p>
          <p className="text-content-soustitre">{Data[5].subtitle}</p>
        

        <p className="text-content-credit">{Data[5].credit}</p>
      </div>
      <div className="text-right">
        <p className="text-content-des">{Data[5].desc}</p>
      </div>
