...
{/* {props.trueboolroute ?  */} 
  ...
  className="central">
    <div className="central-pix">
      <img loading="eager" src={Data[15].pics[0]} className="pixHead" alt="nicocarmine" />
    </div>
    <div className="text">
      ...
      <div className="text-left">
          ...
          <p className="text-content-titre">{Data[15].titre}</p>
          <p className="text-content-soustitre">{Data[15].subtitle}</p>
        

        <p className="text-content-credit">{Data[15].credit}</p>
      </div>
      <div className="text-right">
        <p className="text-content-des">{Data[15].desc}</p>
      </div>
