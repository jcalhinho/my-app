...
const Travaux8 = (props) => {
   
  const dataWithoutFirst = Data[7].pics.slice(1);
...
{/* {props.trueboolroute ?  */} 
  ...
  className="central">
    <div className="central-pix">
      <img loading="eager" src={Data[7].pics[0]} className="pixHead" alt="nicocarmine" />
    </div>
    <div className="text">
      ...
      <div className="text-left">
          ...
          <p className="text-content-titre">{Data[7].titre}</p>
          <p className="text-content-soustitre">{Data[7].subtitle}</p>
        

        <p className="text-content-credit">{Data[7].credit}</p>
      </div>
      <div className="text-right">
        <p className="text-content-des">{Data[7].desc}</p>
      </div>
